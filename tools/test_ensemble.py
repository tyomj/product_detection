...
from mmdet.models.detectors.ensemble_cascade_rcnn import EnsembleCascadeRCNN
...
def parse_args():
    ...
    parser.add_argument('checkpoint', help='checkpoint file', nargs='+')
...
def main():
    ...
    for checkpoint in args.checkpoint:
        ...
        models.append(model)
    model = EnsembleCascadeRCNN(models)
